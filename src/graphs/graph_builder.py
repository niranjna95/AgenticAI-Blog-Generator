...
class GraphBuilder:
    ...
    def build_topic_graph(self):
        """
        Builds a graph for generating a blog topic based on a given topic.
        """
    ...
    def build_language_graph(self):
        """
        Build a graph for generation with input topic and language
        """
        self.blog_node_obj = BlogNode(self.llm)
...
## Below code is for the langsmit langgraph studio
llm =GroqLLM().get_llm()
## get the graph
